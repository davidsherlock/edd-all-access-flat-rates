...
Tags: easy digital downloads, digital, download, downloads, edd, sellcomet, commissions, all access, flat rates, ecommerce, e-store, eshop, marketplace, vendors, transaction
...
Override the All Access weighted commission calculation and reward vendors with flat rate amounts.
...
This plugin requires [Easy Digital Downloads](http://wordpress.org/extend/plugins/easy-digital-downloads/ "Easy Digital Downloads"), [Commissions](https://easydigitaldownloads.com/downloads/commissions/ "Commissions") and [All Access](https://easydigitaldownloads.com/downloads/all-access/ "All Access").
...
Please visit the [support page](https://wordpress.org/support/plugin/edd-all-access-flat-rates) if you need to submit a support request.
...
* Raise an [Issue](https://github.com/davidsherlock/edd-all-access-flat-rates/issues) on GitHub
...
* Provide feedback and suggestions on [enhancements](https://github.com/davidsherlock/edd-all-access-flat-rates/issues?direction=desc&labels=Enhancement&page=1&sort=created&state=open)
