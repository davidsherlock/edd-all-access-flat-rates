...
class EDD_Extension_Activation {
    ...
    public function missing_edd_notice() {
        if( $this->has_edd ) {
            ...
            $link = '<a href="' . $url . '">' . __( 'activate it', 'edd-all-access-flat-rates' ) . '</a>';
        } else {
            ...
            $link = '<a href="' . $url . '">' . __( 'install it', 'edd-all-access-flat-rates' ) . '</a>';
        }

        echo '<div class="error"><p>' . $this->plugin_name . sprintf( __( ' requires Easy Digital Downloads! Please %s to continue!', 'edd-all-access-flat-rates' ), $link ) . '</p></div>';
    }
}
